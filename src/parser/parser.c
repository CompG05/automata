...
int derive_S(char *input, int *cc_idx);
int derive_E(char *input, int *cc_idx);
int derive_Ep(char *input, int *cc_idx);
int derive_T(char *input, int *cc_idx);
int derive_Tp(char *input, int *cc_idx);
int derive_F(char *input, int *cc_idx);
int derive_Fp(char *input, int *cc_idx);
int derive_P(char *input, int *cc_idx);
int derive_L(char *input, int *cc_idx);
...
int derive_E(char *input, int *cc_idx) {
    if (intset_contains(ds[1], input[*cc_idx])) {
        if (!derive_T(input, cc_idx)) return 0;
        if (!derive_Ep(input,cc_idx)) return 0;
        return 1;
    } else {
        return 0;
    }
...
int derive_T(char *input, int *cc_idx) {
    if (intset_contains(ds[4], input[*cc_idx])) {
        if (!derive_F(input, cc_idx)) return 0;
        if (!derive_Tp(input, cc_idx)) return 0;
        return 1;
    } else {
        return 0;
    }
...
int derive_F(char *input, int *cc_idx) {
    if (intset_contains(ds[7], input[*cc_idx])) {
        if (!derive_P(input, cc_idx)) return 0;
        if (!derive_Fp(input, cc_idx)) return 0;
        return 1;
    } else {
        return 0;
    }
...
int derive_P(char *input, int *cc_idx) {
    if (intset_contains(ds[10], input[*cc_idx])) {
        if (!test_cc(input, cc_idx, '(')) return 0;
        if (!derive_E(input, cc_idx)) return 0;
        if (!test_cc(input, cc_idx, ')')) return 0;
        return 1;
    } else if (intset_contains(ds[11], input[*cc_idx])) {
        if (!derive_L(input, cc_idx)) return 0;
        return 1;
    } else {
        return 0;
    }
